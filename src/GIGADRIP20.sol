...
abstract contract GIGADRIP20 {
  ...
  function balanceOf(address addr) public view returns (uint256) {
    ...
    return
      ((block.number - accruer.accrualStartBlock) * emissionRatePerBlock) *
      accruer.multiplier +
      accruer.balance;
  }
  ...
  /*==============================================================
    ==                         HELPERS                            ==
    ==============================================================*/
  function accruerMultiplier(address addr) public view returns (uint256) {
    Accruer storage accruer = _accruers[addr];

    return accruer.multiplier;
  }
}
